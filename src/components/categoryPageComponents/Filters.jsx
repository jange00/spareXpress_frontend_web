const Filters = ({ filters, selectedFilters, onFilterChange, clearFilters }) => {
    const isAnyFilterActive = Object.values(selectedFilters).some((f) =>
    ...
    return (
      <div className="bg-white rounded-lg shadow p-6 space-y-6">
        <div className="flex items-center justify-between">
          ...
          {isAnyFilterActive && (
            <button onClick={clearFilters} className="text-sm text-[#ffc107] hover:text-[#ffcd38]">
              Clear all
            </button>
          )}
        </div>
